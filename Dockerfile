...
RUN echo "Installing winesapOS in 3" && \
sleep 1 && \
echo "Installing winesapOS in 2" && \ 
sleep 1 && \
echo "Installing winesapOS in 1" && \
sleep 1 && \
...
echo "winesapOS installing ... Installer completed successfully"
